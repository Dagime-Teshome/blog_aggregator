...
RETURNING id, user_id, name, url, last_fetched_at, created_at, updated_at
`
...
Select id, user_id, name, url, last_fetched_at, created_at, updated_at from
feeds
where  id = $1
`
...
Select id, user_id, name, url, last_fetched_at, created_at, updated_at from feeds
`
